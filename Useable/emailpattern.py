...
from decouple import config
from Useable import config as conf
...
def forgetEmailPattern(data):
    try:
                                    ...
                                    <td>
                                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td style="background-color: #127DB3;"><img width="250" height="80"  title="logo" alt="logo"></td> -->
                                                <td style="background-color: #ffffff;"><img width="250" height="80"  title="logo" alt="logo"></td>
                                                <!-- <td>valet services</td> -->
                                            </tr>
                                            <tr>
                                                <td style="padding:0 35px; background:#5127eb">
                                                    ...
                                                    <span
                                                        ...
                                                        <p style="color:#ffffff; font-size:19px;line-height:24px; margin:0;
                                                        padding-top: 10px;
                                                        ">
                                            ...
                                            <tr>
                                                <!-- <td style="height:40px;">&nbsp;</td> -->
                                                <td style="background-color: #ffffff;"  ><h4 style="color: #4326aa;">Copyright 2023 - All Right Reserved Vethomes</h4></td>
                                                <!-- <td>valet services</td> -->
                                            </tr>
                                            <tr>
                                                <!-- <td style="height:40px;">&nbsp;</td> -->
        ...
        # message = data['token']
        # send_mail(data['subject'], '' , data['EMAIL_HOST_USER'], [data['toemail']], connection=conf.connection,fail_silently=True)
        ...
        # email= EmailMessage(subject=data['subject'], body= data['token'], from_email= "hnhtechsolutionsemail@gmail.com" , to_email= data['toemail'] )
        # email.send()
